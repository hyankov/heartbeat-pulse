...
class TestProvidersManager(unittest.TestCase):
    ...
    def test_discover_provider_parameters(self):
        # Arrange
        providers_manager = ProvidersManager()

        # Act
        provider_params = providers_manager.discover_provider_parameters(self._fake_provider_id)
    ...
    def test_instantiate(self):
        ...
        # Act
        fake_provider_instance = providers_manager.instantiate(self._fake_provider_id)
